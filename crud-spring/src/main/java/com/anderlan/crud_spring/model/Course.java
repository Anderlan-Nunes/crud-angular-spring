...
public class Course {
  ...
  @GeneratedValue(strategy = GenerationType.IDENTITY) // Essa anotação indica que o valor do campo id será gerado automaticamente pelo banco de dados. O hibernate vai gerar um valor único para o campo id quando um novo curso for criado.
